...
{ 
	...
	public function select()
	{
		...
		if($cursor->getNext())
			include drupal_get_path('module','bible_module').'/layouts/master.layout.php';
		else
			echo "Empty query";
	}
	...
	//Get $book,$chapter and return how mane verses in the chapter
	...
	//Get $book and return how mane chapters
